...
'void main() {\n'+
 ...
 function init(){
    ...
    // uProjMatrix.setOrtho(-1.0,1.0,-1.0,1.0,0.0,2.0);
    uProjMatrix.setOrtho(-0.5,0.5,-0.5,0.5,0.0,2.0);//可视空间高宽比与canvas不一致
 ...
 function drawTriagnles(gl,u_ViewMatrix,uViewMatrix,){
    uViewMatrix.setLookAt(eyeX, eyeY, eyeZ, 0, 0, 0, 0, 1, 0);
